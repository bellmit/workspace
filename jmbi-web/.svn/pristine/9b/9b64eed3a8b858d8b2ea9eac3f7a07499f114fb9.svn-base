...
// ----------------------总览----------------------
// 运营数据概览
// /biservice/v1/enjzx/overview/OperationOverview
...
export function enjzxOperationOverview() {
  let url = `/biservice/v1/enjzx/overview/OperationOverview`
  return fetch(url)
}

// 项目订单分析
// 新增项目订单
// /biservice/v1/enjzx/overview/newProjectOrder/20170101/20171201
...
export function enjzxNewProjectOrder({
  startDate,
  endDate
}) {
  let url = `/biservice/v1/enjzx/overview/newProjectOrder/${startDate}/${endDate}`
  return fetch(url)
}

// 市场营销订单  各行业占比
// /biservice/v1/enjzx/overview/industryShare/3/20170101/20171201
...
export function enjzxIndustryShare({
  startDate,
  endDate,
  todoDetailId, // TODO
}) {
  let url = `/biservice/v1/enjzx/overview/industryShare/${todoDetailId}/${startDate}/${endDate}`
  return fetch(url)
}

// 市场营销订单  各细分服务类型占比
// /biservice/v1/enjzx/overview/TypeRatio/20170101/20171201
...
export function enjzxTypeRatio({
  startDate,
  endDate,
  todoDetailId // TODO
}) {
  let url = `/biservice/v1/enjzx/overview/TypeRatio/${todoDetailId}/${startDate}/${endDate}`
  return fetch(url)
}

// 新增注册用户
// /biservice/v1/enjzx/overview/newRegisteredUser/20170101/20171201
...
export function enjzxNewRegisteredUser({
  startDate,
  endDate
}) {
  let url = `/biservice/v1/enjzx/overview/newRegisteredUser/${startDate}/${endDate}`
  return fetch(url)
}
...
export function enjzxVisitorMapFlow({
  platform,
  startDate,
  endDate
}){
...
// 意向单
// /biservice/v1/enjzx/businessTrend/intentionOrder/platform/102000/startDate/20170604/endDate/20170623/dateType/D
...
export function enjzxIntentionOrder({
  service,
  platform,
  startDate,
  endDate,
  ...
  // let url = `/biservice/v1/enjzx/businessTrend/intentionOrder/platform/${platform}/startDate/${startDate}/endDate/${endDate}/dateType/${dateType}`
  let url = `/biservice/v1/enjzx/businessTrend/${service}/platform/${platform}/startDate/${startDate}/endDate/${endDate}/dateType/${dateType}`
  return fetch(url)
}
