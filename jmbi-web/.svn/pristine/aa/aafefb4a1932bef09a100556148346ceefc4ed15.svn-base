...
public class InOutCustomsBean implements Serializable {
    ...
    /**
     * Creates a new instance of InOutCustomsBean
     * 
     * @param rowkey
     * @param customsName
     * @param inoutType
     ...
     * @param index
     */
    public InOutCustomsBean(String rowkey, String customsName, String inoutType, String customsCode, BigDecimal totalAmount, int index) {
        super();
        this.rowkey = rowkey;
