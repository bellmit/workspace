  ...
  <header class="top-header clearfix">
    ...
    <div class="user-profile right ">
      <a class="platform">平台切换：
        <span class="dropdown">{{platformName}}
          <i class="icon-link"></i>
        </span>
              ...
              <div class="en-item-list clearfix">
                ...
                <ul>
                  ...
                  <template v-if="hasVisiblePlatform(servicePlatformIds)">
                    ...
                    <li v-if="isVisible('000000')">
                    <p>
                    <a href="/index2?platformId=101501">JUMORE Technology</a><!--智能-->
                    </p>
                    </li>
                    <li v-if="isVisible('00000000')">
                    <p>
                    <a href="/index2?platformId=101501">JUMORE Certification</a><!--认证-->
                    </p>
                    </li>
...
export default {
  ...
  data() {
    return {
      ...
      platformName: '',
      isAdmin: false,
      tradePlatformList: ['100100', ...tradePlatformIds],
      servicePlatformIds: servicePlatformIds
    }
  }
}
