    ...
    <el-row class="jm-grid-border-1px">
      <el-col :xs="24" :sm="24" :md="24" :lg="24">
        <div class="grid-content jm-grid-box-bg-white">
          ...
          <chart-box v-on:loadOption="loadnewAddedUsersLineChart" :chartBoxClass="newAddedUsersLineChartBoxClass" apiName="enjytRegisterNewlyIncr" :apiParams="jytRegisterNewlyIncrChartApiParams" seriesDataProperty="lineChart.seriesData"></chart-box>
        </div>
      </el-col>
