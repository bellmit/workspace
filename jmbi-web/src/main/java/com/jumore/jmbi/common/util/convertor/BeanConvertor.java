...
public class BeanConvertor {
    ...
    private static final LogHelper Log_Helper = LogHelper.getLogger(BeanConvertor.class);
    ...
    public static <T> T copy(Object source, Class<T> target, String... ignoreProperties) {
        ...
        try {
            ...
            Log_Helper.getBuilder().error(BaseExceptionEnum.INSTANTIATION_EXCEPTION.getMsg(), e);
        }
