...
public class InOutGoodsBean implements Serializable {
    ...
    /**
     * Creates a new instance of InOutGoodsBean
     * 
     * @param rowkey
     * @param goodsCode
     * @param goodsName
     ...
     * @param index
     */
    public InOutGoodsBean(String rowkey, String goodsCode, String goodsName, String inoutType, String customsCode, BigDecimal totalAmount,
            int index) {
        super();
        this.rowkey = rowkey;
