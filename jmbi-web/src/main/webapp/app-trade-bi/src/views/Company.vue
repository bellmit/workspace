      ...
      <div class="clearfix">
        <el-col :xs="24" :sm="24" :md="24" :lg="8">
          <div class="grid-content">
            <div class="box sixteen-nine c-order-box" v-loading="cOrderNumChartEmpty" element-loading-text="暂无运营数据">
              <div class="content" ref='cOrderNumChart'>
  
              </div>
              <a v-bind:href="exportLink2" target="_blank" class="c-order-upload"></a>
            </div>
          </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="8">
          <div class="grid-content">
            <div class="box sixteen-nine c-order-box" v-loading="cOrderValChartEmpty" element-loading-text="暂无运营数据">
              <div class="content" ref='cOrderValChart'>
  
              </div>
              <a v-bind:href="exportLink4" target="_blank" class="c-order-upload"></a>
            </div>
          </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="8">
          <div class="grid-content">
            <div class="box sixteen-nine c-order-box" v-loading="cOrderIncomeChartEmpty" element-loading-text="暂无运营数据">
              <div class="content" ref='cOrderIncomeChart'>
  
              </div>
              <a v-bind:href="exportLink6" target="_blank" class="c-order-upload"></a>
            </div>
  
          </div>
        </el-col>
      </div>
      <header class="panel-header jm-grid-border-bottom-1px c-header c-header1">
        <span>客户企业</span>
      </header>
      <div class="clearfix">
        <el-col :xs="24" :sm="24" :md="24" :lg="8">
          <div class="grid-content">
            <div class="box sixteen-nine c-order-box" v-loading="cCustomerNumChartEmpty" element-loading-text="暂无运营数据">
              <div class="content" ref='cCustomerNumChart'>
  
              </div>
              <a v-bind:href="exportLink1" target="_blank" class="c-order-upload"></a>
            </div>
          </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="8">
          <div class="grid-content">
            <div class="box sixteen-nine c-order-box" v-loading="cCustomerValChartEmpty" element-loading-text="暂无运营数据">
              <div class="content" ref='cCustomerValChart'>
  
              </div>
              <a v-bind:href="exportLink3" target="_blank" class="c-order-upload"></a>
            </div>
          </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="8">
          <div class="grid-content">
            <div class="box sixteen-nine c-order-box" v-loading="cCustomerIncomeChartEmpty" element-loading-text="暂无运营数据">
              <div class="content" ref='cCustomerIncomeChart'>
  
              </div>
              <a v-bind:href="exportLink5" target="_blank" class="c-order-upload"></a>
            </div>
