<template>
  <div>
    ...
    <el-breadcrumb separator=">">
      ...
      <el-breadcrumb-item :to="{ path: '/' }">聚贸通平台</el-breadcrumb-item>
    ...
    <el-row class="jm-grid-box-bg-white jm-grid-border-1px jm-margin-top20 import-export-container ">
      ...
      <div class="clearfix">
        <el-col :xs="24" :sm="24" :md="24" :lg="gridColumnSpan">
          <div class="grid-content">
            <div class="box sixteen-nine ie-order-box" v-loading="cOrderNumChartEmpty" element-loading-text="暂无运营数据">
              <div class="content" ref='cOrderNumChart'>
  
              </div>
              <a v-bind:href="exportInGoodsAmount" target="_blank" class="c-order-upload"></a>
            </div>
          </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="gridColumnSpan" v-if="!isSelectedKouan">
          <div class="grid-content kouan-container">
            <div class="box sixteen-nine ie-order-box" v-loading="cOrderValChartEmpty" element-loading-text="暂无运营数据">
              <div class="content" ref='cOrderValChart'>
  
              </div>
              <a v-bind:href="exportInCustomsAmount" target="_blank" class="c-order-upload"></a>
            </div>
          </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="gridColumnSpan">
          <div class="grid-content">
            <div class="box sixteen-nine ie-order-box" v-loading="cOrderIncomeChartEmpty" element-loading-text="暂无运营数据">
              <div class="content" ref='cOrderIncomeChart'>
  
              </div>
              <a v-bind:href="exportInCountry" target="_blank" class="c-order-upload"></a>
            </div>
  
          </div>
        </el-col>
      </div>
      <header class="panel-header jm-grid-border-top-1px jm-grid-border-bottom-1px c-header c-header1">
        <span>出口</span>
      </header>
      <div class="clearfix jm-padding-bottom-20">
        <el-col :xs="24" :sm="24" :md="24" :lg="gridColumnSpan">
          <div class="grid-content">
            <div class="box sixteen-nine ie-order-box" v-loading="cCustomerNumChartEmpty" element-loading-text="暂无运营数据">
              <div class="content" ref='cCustomerNumChart'>
  
              </div>
              <a v-bind:href="exportOutGoodsAmount" target="_blank" class="c-order-upload"></a>
            </div>
          </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="gridColumnSpan" v-if="!isSelectedKouan">
          <div class="grid-content kouan-container">
            <div class="box sixteen-nine ie-order-box" v-loading="cCustomerValChartEmpty" element-loading-text="暂无运营数据">
              <div class="content" ref='cCustomerValChart'>
  
              </div>
              <a v-bind:href="exportOutCustomsAmount" target="_blank" class="c-order-upload"></a>
            </div>
          </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="gridColumnSpan">
          <div class="grid-content">
            <div class="box sixteen-nine ie-order-box" v-loading="cCustomerIncomeChartEmpty" element-loading-text="暂无运营数据">
              <div class="content" ref='cCustomerIncomeChart'>
  
              </div>
              <a v-bind:href="exportOutCountry" target="_blank" class="c-order-upload"></a>
            </div>
