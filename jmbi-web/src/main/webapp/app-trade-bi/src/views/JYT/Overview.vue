    ...
    <el-row>
      ...
      <el-col :span="24">
        ...
        <div class="grid-content jm-grid-box-bg-white jm-grid-border-1px zhibiao-activeTabName chart-setting-items-container">
          ...
          <chart-box v-on:loadOption="loadOverviewLineChart" :chartBoxClass="overviewLineChartBoxClass" apiName="jytOverviewLineChart" :apiParams="overviewLineChartApiParams" seriesDataProperty="lineChart.seriesData"></chart-box>
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="24" :lg="12">
        <div class="grid-content jm-grid-box-bg-white jm-grid-border-1px">
          ...
          <chart-box v-on:loadOption="loadTransportLineChartOption" apiName="jytOverviewTransportLine" :apiParams="overviewTransportLineApiParams" seriesDataProperty="pieChart.seriesData"></chart-box>
      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="12">
        <div class="grid-content jm-grid-box-bg-white jm-grid-border-1px">
          ...
          <chart-box v-on:loadOption="loadRequireTop5ChartOption" apiName="jytOverviewRequireTop5" :apiParams="overviewRequireTop5ApiParams" seriesDataProperty="lineChart.seriesData"></chart-box>
...
export default {
  ...
  methods: {
    ...
    loadAllData() {
      ...
      vm.loadOverviewItems('1-2-3-4-5-6')
