package org.jumao.bi.dao.enjyt;
...
public interface EnJytPayDao {
    ...
    /**
        运力图公路
     */
    Map<String, String> airFreight(String startDate, String endDate);

    Map<String,String> railTransport(String startDate, String endDate);

    Map<String,String> landTransport(String startDate, String endDate);

    Map<String,String> warehouseTransport(String startDate, String endDate);
